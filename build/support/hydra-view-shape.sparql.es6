...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/%%NOTATION%%> a qb:DataSet ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    ...
    OPTIONAL { <http://ld.stadt-zuerich.ch/statistics/dataset/%%NOTATION%%> <http://purl.org/dc/terms/license> ?license }
