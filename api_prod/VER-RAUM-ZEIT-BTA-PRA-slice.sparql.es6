...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/VER-RAUM-ZEIT-BTA-PRA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/VER-RAUM-ZEIT-BTA-PRA> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/BTA> ?bta;
        <https://ld.stadt-zuerich.ch/statistics/property/PRA> ?pra;
