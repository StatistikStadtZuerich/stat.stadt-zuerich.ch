...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/ABL-RAUM-ZEIT-ALT-HEL/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/ABL-RAUM-ZEIT-ALT-HEL> ;
        ?property ?value.
