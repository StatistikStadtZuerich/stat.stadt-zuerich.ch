...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/AST-RAUM-ZEIT-BTA-TIG/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/AST-RAUM-ZEIT-BTA-TIG> ;
        ?property ?value.
