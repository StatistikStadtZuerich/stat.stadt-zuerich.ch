...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/WRT-RAUM-ZEIT-HAA-OBJ> a qb:DataSet ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <http://ld.stadt-zuerich.ch/statistics/dataset/WRT-RAUM-ZEIT-HAA-OBJ> a qb:DataSet ;
      qb:slice ?defaultSlice ;
      qb:slice ?slice ;
      sdmx-attribute:unitMeasure ?unit ;
      rdfs:label ?datasetLabel .

    OPTIONAL { <http://ld.stadt-zuerich.ch/statistics/dataset/WRT-RAUM-ZEIT-HAA-OBJ> <http://purl.org/dc/terms/license> ?license }
