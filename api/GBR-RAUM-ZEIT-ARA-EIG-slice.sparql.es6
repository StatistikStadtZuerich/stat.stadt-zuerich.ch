...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/GBR-RAUM-ZEIT-ARA-EIG/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/GBR-RAUM-ZEIT-ARA-EIG> ;
        ?property ?value.
