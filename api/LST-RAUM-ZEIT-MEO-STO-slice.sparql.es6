...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/LST-RAUM-ZEIT-MEO-STO/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/LST-RAUM-ZEIT-MEO-STO> ;
        ?property ?value.
