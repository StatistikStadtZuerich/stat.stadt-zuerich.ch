...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/SER-RAUM-ZEIT-PSA-STA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/SER-RAUM-ZEIT-PSA-STA> ;
        ?property ?value.
