...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/UGR-RAUM-ZEIT-MEO-STO/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/UGR-RAUM-ZEIT-MEO-STO> ;
        ?property ?value.
      ...
      ?observation
        ...
        <https://ld.stadt-zuerich.ch/statistics/property/STO> <https://ld.stadt-zuerich.ch/statistics/code/STO4005>;
