...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/SER-RAUM-ZEIT-KKL-PSA-STA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/SER-RAUM-ZEIT-KKL-PSA-STA> ;
        ?property ?value.
