...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/SER-RAUM-ZEIT-KKL-PSA-STA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/SER-RAUM-ZEIT-KKL-PSA-STA> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/KKL> ?kkl;
        ...
        <https://ld.stadt-zuerich.ch/statistics/property/STA> ?sta;
