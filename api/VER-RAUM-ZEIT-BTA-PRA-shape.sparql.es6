...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/VER-RAUM-ZEIT-BTA-PRA> a qb:DataSet ;
...
#  ?sliceApi rdfs:label ?sliceLabel .
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/VER-RAUM-ZEIT-BTA-PRA/shape> a sh:NodeShape ;
