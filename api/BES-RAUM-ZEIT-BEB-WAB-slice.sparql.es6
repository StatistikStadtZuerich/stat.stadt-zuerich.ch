...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/BES-RAUM-ZEIT-BEB-WAB/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/BES-RAUM-ZEIT-BEB-WAB> ;
        ?property ?value.
