...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/GBD-RAUM-ZEIT-ARA-EIG> a qb:DataSet ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <http://ld.stadt-zuerich.ch/statistics/dataset/GBD-RAUM-ZEIT-ARA-EIG> a qb:DataSet ;
      qb:slice ?defaultSlice ;
      qb:slice ?slice ;
      sdmx-attribute:unitMeasure ?unit ;
      rdfs:label ?datasetLabel .

    OPTIONAL { <http://ld.stadt-zuerich.ch/statistics/dataset/GBD-RAUM-ZEIT-ARA-EIG> <http://purl.org/dc/terms/license> ?license }
