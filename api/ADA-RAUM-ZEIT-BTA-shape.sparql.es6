...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/ADA-RAUM-ZEIT-BTA> a qb:DataSet ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    ...
    OPTIONAL { <http://ld.stadt-zuerich.ch/statistics/dataset/ADA-RAUM-ZEIT-BTA> <http://purl.org/dc/terms/license> ?license }
