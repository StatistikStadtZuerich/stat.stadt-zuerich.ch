...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/PUN-RAUM-ZEIT-VET-VUN/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/PUN-RAUM-ZEIT-VET-VUN> ;
        ?property ?value.
