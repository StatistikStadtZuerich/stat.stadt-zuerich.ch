...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/SSA-RAUM-ZEIT-BTA-SAR-STS/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/SSA-RAUM-ZEIT-BTA-SAR-STS> ;
        ?property ?value.
      ...
      ?observation
        ...
        <http://ld.stadt-zuerich.ch/statistics/property/STS> ?sts;
