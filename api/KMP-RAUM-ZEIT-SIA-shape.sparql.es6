...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/KMP-RAUM-ZEIT-SIA> a qb:DataSet ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <https://ld.stadt-zuerich.ch/statistics/dataset/KMP-RAUM-ZEIT-SIA> a qb:DataSet ;
      qb:slice ?defaultSlice ;
      qb:slice ?slice ;
      sdmx-attribute:unitMeasure ?unit ;
      rdfs:label ?datasetLabel .

    OPTIONAL { <https://ld.stadt-zuerich.ch/statistics/dataset/KMP-RAUM-ZEIT-SIA> <http://purl.org/dc/terms/license> ?license }
