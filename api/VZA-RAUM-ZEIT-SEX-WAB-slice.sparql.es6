...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/VZA-RAUM-ZEIT-SEX-WAB/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/VZA-RAUM-ZEIT-SEX-WAB> ;
        ?property ?value.
