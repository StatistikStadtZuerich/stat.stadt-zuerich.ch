...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/KUB-RAUM-ZEIT-BTA-SST/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/KUB-RAUM-ZEIT-BTA-SST> ;
        ?property ?value.
