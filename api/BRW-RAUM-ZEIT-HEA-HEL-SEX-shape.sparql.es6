...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/BRW-RAUM-ZEIT-HEA-HEL-SEX> a qb:DataSet ;
...
#  ?sliceApi rdfs:label ?sliceLabel .
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/BRW-RAUM-ZEIT-HEA-HEL-SEX/shape> a sh:NodeShape ;
