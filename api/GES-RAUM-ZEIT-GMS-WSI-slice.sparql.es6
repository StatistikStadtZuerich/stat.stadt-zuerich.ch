...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/GES-RAUM-ZEIT-GMS-WSI/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/GES-RAUM-ZEIT-GMS-WSI> ;
        ?property ?value.
