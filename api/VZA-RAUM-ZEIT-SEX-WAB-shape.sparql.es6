...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/VZA-RAUM-ZEIT-SEX-WAB> a qb:DataSet ;
...
#  ?sliceApi rdfs:label ?sliceLabel .
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/VZA-RAUM-ZEIT-SEX-WAB/shape> a sh:NodeShape ;
