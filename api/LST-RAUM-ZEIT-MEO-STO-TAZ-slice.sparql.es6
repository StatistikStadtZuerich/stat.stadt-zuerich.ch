...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/LST-RAUM-ZEIT-MEO-STO-TAZ/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/LST-RAUM-ZEIT-MEO-STO-TAZ> ;
        ?property ?value.
      ...
      ?observation
        ...
        <http://ld.stadt-zuerich.ch/statistics/property/TAZ> ?taz;
