...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/EHE-RAUM-ZEIT-HEF-HEM/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/EHE-RAUM-ZEIT-HEF-HEM> ;
        ?property ?value.

      # dimensions
      ?observation
        <http://ld.stadt-zuerich.ch/statistics/property/HEF> ?hef;
        <http://ld.stadt-zuerich.ch/statistics/property/HEM> ?hem;
