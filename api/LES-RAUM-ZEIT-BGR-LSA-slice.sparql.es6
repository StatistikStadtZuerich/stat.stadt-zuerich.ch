...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/LES-RAUM-ZEIT-BGR-LSA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/LES-RAUM-ZEIT-BGR-LSA> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/BGR> ?bgr;
        <https://ld.stadt-zuerich.ch/statistics/property/LSA> ?lsa;
