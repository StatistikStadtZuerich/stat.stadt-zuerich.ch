...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/GBU-RAUM-ZEIT-ADM-ADV-ELK/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/GBU-RAUM-ZEIT-ADM-ADV-ELK> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/ADM> ?adm;
        <https://ld.stadt-zuerich.ch/statistics/property/ADV> ?adv;
