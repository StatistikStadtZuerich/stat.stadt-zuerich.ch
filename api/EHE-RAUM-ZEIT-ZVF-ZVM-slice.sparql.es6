...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/EHE-RAUM-ZEIT-ZVF-ZVM/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/EHE-RAUM-ZEIT-ZVF-ZVM> ;
        ?property ?value.
      ...
      ?observation
        ...
        <https://ld.stadt-zuerich.ch/statistics/property/ZVF> ?zvf;
        <https://ld.stadt-zuerich.ch/statistics/property/ZVM> ?zvm .
