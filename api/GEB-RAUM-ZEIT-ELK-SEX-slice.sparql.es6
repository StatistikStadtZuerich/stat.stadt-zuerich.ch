...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/GEB-RAUM-ZEIT-ELK-SEX/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/GEB-RAUM-ZEIT-ELK-SEX> ;
        ?property ?value.
