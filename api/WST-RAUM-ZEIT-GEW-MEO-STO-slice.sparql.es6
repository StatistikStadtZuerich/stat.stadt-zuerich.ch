...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/WST-RAUM-ZEIT-GEW-MEO-STO/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/WST-RAUM-ZEIT-GEW-MEO-STO> ;
        ?property ?value.
