...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/ZUZ-RAUM-ZEIT/shape> a sh:NodeShape ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <http://ld.stadt-zuerich.ch/statistics/dataset/ZUZ-RAUM-ZEIT/shape> sh:property ?b_property .
