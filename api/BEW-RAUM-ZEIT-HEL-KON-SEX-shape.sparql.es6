...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/BEW-RAUM-ZEIT-HEL-KON-SEX/shape> a sh:NodeShape ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <http://ld.stadt-zuerich.ch/statistics/dataset/BEW-RAUM-ZEIT-HEL-KON-SEX/shape> sh:property ?b_property .
