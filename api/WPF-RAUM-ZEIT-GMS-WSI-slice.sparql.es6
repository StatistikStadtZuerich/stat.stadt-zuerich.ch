...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/WPF-RAUM-ZEIT-GMS-WSI/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/WPF-RAUM-ZEIT-GMS-WSI> ;
        ?property ?value.
