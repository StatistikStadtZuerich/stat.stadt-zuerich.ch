...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/SWB-RAUM-ZEIT-HEL-ORT/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/SWB-RAUM-ZEIT-HEL-ORT> ;
        ?property ?value.
