...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/SWB-RAUM-ZEIT-HEL-ORT/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/SWB-RAUM-ZEIT-HEL-ORT> ;
        ?property ?value.
