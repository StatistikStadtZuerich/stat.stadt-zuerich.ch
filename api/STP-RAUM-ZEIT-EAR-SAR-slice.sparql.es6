...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/STP-RAUM-ZEIT-EAR-SAR/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/STP-RAUM-ZEIT-EAR-SAR> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/EAR> ?ear;
