...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/LON-RAUM-ZEIT-BTA-HER> a qb:DataSet ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <https://ld.stadt-zuerich.ch/statistics/dataset/LON-RAUM-ZEIT-BTA-HER> a qb:DataSet ;
      qb:slice ?defaultSlice ;
      qb:slice ?slice ;
      sdmx-attribute:unitMeasure ?unit ;
      rdfs:label ?datasetLabel .

    OPTIONAL { <https://ld.stadt-zuerich.ch/statistics/dataset/LON-RAUM-ZEIT-BTA-HER> <http://purl.org/dc/terms/license> ?license }
