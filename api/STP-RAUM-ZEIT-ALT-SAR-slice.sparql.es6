...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/STP-RAUM-ZEIT-ALT-SAR/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/STP-RAUM-ZEIT-ALT-SAR> ;
        ?property ?value.
      ...
      ?observation
        ...
        <https://ld.stadt-zuerich.ch/statistics/property/SAR> <https://ld.stadt-zuerich.ch/statistics/code/SAR1001>;
