...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/EHS-RAUM-ZEIT-SEX-WSE> a qb:DataSet ;
...
#  ?sliceApi rdfs:label ?sliceLabel .
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/EHS-RAUM-ZEIT-SEX-WSE/shape> a sh:NodeShape ;
