...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/BEW-RAUM-ZEIT-ALT-SEX> a qb:DataSet ;
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/BEW-RAUM-ZEIT-ALT-SEX/shape> a sh:NodeShape ;
