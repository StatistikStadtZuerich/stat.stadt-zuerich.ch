...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/GES-RAUM-ZEIT-ALT-SEX/shape> a sh:NodeShape ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <http://ld.stadt-zuerich.ch/statistics/dataset/GES-RAUM-ZEIT-ALT-SEX/shape> sh:property ?b_property .
