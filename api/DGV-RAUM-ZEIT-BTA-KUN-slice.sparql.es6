...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/DGV-RAUM-ZEIT-BTA-KUN/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/DGV-RAUM-ZEIT-BTA-KUN> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/BTA> <https://ld.stadt-zuerich.ch/statistics/code/BTA91I1>;
        <https://ld.stadt-zuerich.ch/statistics/property/KUN> <https://ld.stadt-zuerich.ch/statistics/code/KUN1000>;
