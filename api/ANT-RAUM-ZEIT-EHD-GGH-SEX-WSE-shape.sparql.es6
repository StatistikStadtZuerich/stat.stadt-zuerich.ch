...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/ANT-RAUM-ZEIT-EHD-GGH-SEX-WSE> a qb:DataSet ;
...
#  ?sliceApi rdfs:label ?sliceLabel .
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/ANT-RAUM-ZEIT-EHD-GGH-SEX-WSE/shape> a sh:NodeShape ;
