...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/FST-RAUM-ZEIT-GRE-STO/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/FST-RAUM-ZEIT-GRE-STO> ;
        ?property ?value.
