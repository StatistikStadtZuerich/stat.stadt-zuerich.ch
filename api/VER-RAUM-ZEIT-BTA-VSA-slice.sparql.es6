...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/VER-RAUM-ZEIT-BTA-VSA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/VER-RAUM-ZEIT-BTA-VSA> ;
        ?property ?value.
