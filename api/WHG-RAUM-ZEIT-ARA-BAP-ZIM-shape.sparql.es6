...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/WHG-RAUM-ZEIT-ARA-BAP-ZIM> a qb:DataSet ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <https://ld.stadt-zuerich.ch/statistics/dataset/WHG-RAUM-ZEIT-ARA-BAP-ZIM> a qb:DataSet ;
      qb:slice ?defaultSlice ;
      qb:slice ?slice ;
      sdmx-attribute:unitMeasure ?unit ;
      rdfs:label ?datasetLabel .

    OPTIONAL { <https://ld.stadt-zuerich.ch/statistics/dataset/WHG-RAUM-ZEIT-ARA-BAP-ZIM> <http://purl.org/dc/terms/license> ?license }
