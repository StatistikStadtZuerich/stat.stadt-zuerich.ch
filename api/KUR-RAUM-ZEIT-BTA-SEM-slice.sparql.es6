...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/KUR-RAUM-ZEIT-BTA-SEM/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/KUR-RAUM-ZEIT-BTA-SEM> ;
        ?property ?value.
