...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/SCH-RAUM-ZEIT-BTA-HEL-RBZ-SEX/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/SCH-RAUM-ZEIT-BTA-HEL-RBZ-SEX> ;
        ?property ?value.
      ...
      ?observation
        ...
        <https://ld.stadt-zuerich.ch/statistics/property/RBZ> <https://ld.stadt-zuerich.ch/statistics/code/RBZ0001>;
