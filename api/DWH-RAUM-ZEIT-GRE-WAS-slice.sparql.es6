...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/DWH-RAUM-ZEIT-GRE-WAS/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/DWH-RAUM-ZEIT-GRE-WAS> ;
        ?property ?value.
