...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/STF-RAUM-ZEIT-ARA-BBA-EIG/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/STF-RAUM-ZEIT-ARA-BBA-EIG> ;
        ?property ?value.
