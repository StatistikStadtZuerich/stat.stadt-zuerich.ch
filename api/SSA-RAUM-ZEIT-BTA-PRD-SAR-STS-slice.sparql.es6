...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/SSA-RAUM-ZEIT-BTA-PRD-SAR-STS/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/SSA-RAUM-ZEIT-BTA-PRD-SAR-STS> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/BTA> ?bta;
        <https://ld.stadt-zuerich.ch/statistics/property/PRD> ?prd;
        <https://ld.stadt-zuerich.ch/statistics/property/RAUM> <https://ld.stadt-zuerich.ch/statistics/code/R30000>;
        <https://ld.stadt-zuerich.ch/statistics/property/SAR> ?sar;
        <https://ld.stadt-zuerich.ch/statistics/property/STS> <https://ld.stadt-zuerich.ch/statistics/code/STS2000>;
        <https://ld.stadt-zuerich.ch/statistics/property/ZEIT> ?zeit .

      # notations for filters
      ?bta skos:notation ?btaNotation .
      ?prd skos:notation ?prdNotation .
      ...
      ${typeof prd !== 'undefined' ? 'FILTER (?prdNotation IN (' + (prd.join ? prd.map(v => v.toCanonical()).join() : prd.toCanonical()) + '))' : ''}
