...
CONSTRUCT {
  <http://stat.integ.stadt-zuerich.ch/api/dataset/BEW-RAUM-ZEIT-GMS-WSI> a qb:DataSet ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <http://ld.stadt-zuerich.ch/statistics/dataset/BEW-RAUM-ZEIT-GMS-WSI> a qb:DataSet ;
      qb:slice ?defaultSlice ;
      qb:slice ?slice ;
      rdfs:label ?datasetLabel .
