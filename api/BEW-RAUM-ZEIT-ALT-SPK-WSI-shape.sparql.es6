...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/BEW-RAUM-ZEIT-ALT-SPK-WSI> a qb:DataSet ;
...
#  ?sliceApi rdfs:label ?sliceLabel .
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/BEW-RAUM-ZEIT-ALT-SPK-WSI/shape> a sh:NodeShape ;
