...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/STG-RAUM-ZEIT-PER-PRE/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/STG-RAUM-ZEIT-PER-PRE> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/PER> ?per;
