...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/ESS-RAUM-ZEIT-PSA-STA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/ESS-RAUM-ZEIT-PSA-STA> ;
        ?property ?value.
      ...
      ?observation
        ...
        <https://ld.stadt-zuerich.ch/statistics/property/STA> <https://ld.stadt-zuerich.ch/statistics/code/STA1200>;
