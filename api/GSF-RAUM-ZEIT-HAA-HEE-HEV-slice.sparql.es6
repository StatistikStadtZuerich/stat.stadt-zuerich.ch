...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/GSF-RAUM-ZEIT-HAA-HEE-HEV/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/GSF-RAUM-ZEIT-HAA-HEE-HEV> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/HAA> <https://ld.stadt-zuerich.ch/statistics/code/HAA0000>;
        <https://ld.stadt-zuerich.ch/statistics/property/HEE> ?hee;
