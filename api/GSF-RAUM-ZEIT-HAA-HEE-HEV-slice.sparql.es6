...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/GSF-RAUM-ZEIT-HAA-HEE-HEV/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/GSF-RAUM-ZEIT-HAA-HEE-HEV> ;
        ?property ?value.

      # dimensions
      ?observation
        <http://ld.stadt-zuerich.ch/statistics/property/HAA> <http://ld.stadt-zuerich.ch/statistics/code/HAA0000>;
        <http://ld.stadt-zuerich.ch/statistics/property/HEE> ?hee;
        <http://ld.stadt-zuerich.ch/statistics/property/HEV> ?hev;
