...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/BAT-RAUM-ZEIT-BEB-BTA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/BAT-RAUM-ZEIT-BEB-BTA> ;
        ?property ?value.
