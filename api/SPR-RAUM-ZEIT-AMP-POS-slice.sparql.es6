...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/SPR-RAUM-ZEIT-AMP-POS/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/SPR-RAUM-ZEIT-AMP-POS> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/AMP> ?amp;
        <https://ld.stadt-zuerich.ch/statistics/property/POS> ?pos;
