...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/ABG-RAUM-ZEIT-STI-VOR/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/ABG-RAUM-ZEIT-STI-VOR> ;
        ?property ?value.
