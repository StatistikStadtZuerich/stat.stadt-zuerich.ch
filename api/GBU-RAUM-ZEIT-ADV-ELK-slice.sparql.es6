...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/GBU-RAUM-ZEIT-ADV-ELK/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/GBU-RAUM-ZEIT-ADV-ELK> ;
        ?property ?value.
