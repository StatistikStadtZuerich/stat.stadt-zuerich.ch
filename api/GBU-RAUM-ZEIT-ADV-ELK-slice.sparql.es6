...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/GBU-RAUM-ZEIT-ADV-ELK/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/GBU-RAUM-ZEIT-ADV-ELK> ;
        ?property ?value.
