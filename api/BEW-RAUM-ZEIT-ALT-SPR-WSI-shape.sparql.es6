...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/BEW-RAUM-ZEIT-ALT-SPR-WSI> a qb:DataSet ;
...
#  ?sliceApi rdfs:label ?sliceLabel .
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/BEW-RAUM-ZEIT-ALT-SPR-WSI/shape> a sh:NodeShape ;
