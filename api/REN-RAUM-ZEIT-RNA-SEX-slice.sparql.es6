...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/REN-RAUM-ZEIT-RNA-SEX/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/REN-RAUM-ZEIT-RNA-SEX> ;
        ?property ?value.
