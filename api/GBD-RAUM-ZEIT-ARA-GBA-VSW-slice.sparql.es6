...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/GBD-RAUM-ZEIT-ARA-GBA-VSW/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/GBD-RAUM-ZEIT-ARA-GBA-VSW> ;
        ?property ?value.
      ...
      ?observation
        ...
        <http://ld.stadt-zuerich.ch/statistics/property/VSW> ?vsw;
