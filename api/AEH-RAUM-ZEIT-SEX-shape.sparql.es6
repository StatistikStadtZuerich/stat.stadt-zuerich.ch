...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/AEH-RAUM-ZEIT-SEX> a qb:DataSet ;
...
#  ?sliceApi rdfs:label ?sliceLabel .
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/AEH-RAUM-ZEIT-SEX/shape> a sh:NodeShape ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <http://ld.stadt-zuerich.ch/statistics/dataset/AEH-RAUM-ZEIT-SEX> a qb:DataSet ;
      qb:slice ?slice .
#      rdfs:label ?datasetLabel .
