...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/SCH-RAUM-ZEIT-BTA-HER-SST/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/SCH-RAUM-ZEIT-BTA-HER-SST> ;
        ?property ?value.
