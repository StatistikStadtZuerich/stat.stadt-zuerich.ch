...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/STA-RAUM-ZEIT-STI-VOR/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/STA-RAUM-ZEIT-STI-VOR> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/RAUM> <https://ld.stadt-zuerich.ch/statistics/code/R40000>;
        <https://ld.stadt-zuerich.ch/statistics/property/STI> ?sti;
        <https://ld.stadt-zuerich.ch/statistics/property/VOR> ?vor;
