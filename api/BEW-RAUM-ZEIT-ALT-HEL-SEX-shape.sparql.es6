...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/BEW-RAUM-ZEIT-ALT-HEL-SEX> a qb:DataSet ;
...
#  ?sliceApi rdfs:label ?sliceLabel .
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/BEW-RAUM-ZEIT-ALT-HEL-SEX/shape> a sh:NodeShape ;
