...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/APA-RAUM-ZEIT-PAT-WAH/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/APA-RAUM-ZEIT-PAT-WAH> ;
        ?property ?value.
      ...
      ?observation
        ...
        <http://ld.stadt-zuerich.ch/statistics/property/WAH> ?wah;
