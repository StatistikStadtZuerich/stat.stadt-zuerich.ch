...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/PPS-RAUM-ZEIT-PAT-WAH/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/PPS-RAUM-ZEIT-PAT-WAH> ;
        ?property ?value.
