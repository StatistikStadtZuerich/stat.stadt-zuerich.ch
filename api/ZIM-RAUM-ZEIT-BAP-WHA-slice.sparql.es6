...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/ZIM-RAUM-ZEIT-BAP-WHA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/ZIM-RAUM-ZEIT-BAP-WHA> ;
        ?property ?value.
