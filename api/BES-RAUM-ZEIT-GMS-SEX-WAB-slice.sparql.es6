...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/BES-RAUM-ZEIT-GMS-SEX-WAB/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/BES-RAUM-ZEIT-GMS-SEX-WAB> ;
        ?property ?value.
