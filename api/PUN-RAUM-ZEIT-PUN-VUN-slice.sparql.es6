...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/PUN-RAUM-ZEIT-PUN-VUN/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/PUN-RAUM-ZEIT-PUN-VUN> ;
        ?property ?value.
      ...
      ?observation
        ...
        <http://ld.stadt-zuerich.ch/statistics/property/VUN> <http://ld.stadt-zuerich.ch/statistics/code/VUN1200>;
