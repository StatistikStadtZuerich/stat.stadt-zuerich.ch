...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/SCK-RAUM-ZEIT-BTA-SST/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/SCK-RAUM-ZEIT-BTA-SST> ;
        ?property ?value.
