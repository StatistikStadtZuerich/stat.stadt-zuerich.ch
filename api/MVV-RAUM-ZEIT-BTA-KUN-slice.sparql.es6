...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/MVV-RAUM-ZEIT-BTA-KUN/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/MVV-RAUM-ZEIT-BTA-KUN> ;
        ?property ?value.
