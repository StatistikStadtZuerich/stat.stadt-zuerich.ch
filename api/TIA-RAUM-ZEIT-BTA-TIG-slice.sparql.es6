...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/TIA-RAUM-ZEIT-BTA-TIG/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/TIA-RAUM-ZEIT-BTA-TIG> ;
        ?property ?value.
      ...
      ?observation
        ...
        <https://ld.stadt-zuerich.ch/statistics/property/TIG> ?tig;
