...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/ANT-RAUM-ZEIT-EHD-GGH-SEX/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/ANT-RAUM-ZEIT-EHD-GGH-SEX> ;
        ?property ?value.
