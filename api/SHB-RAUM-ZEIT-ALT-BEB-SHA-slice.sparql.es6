...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/dataset/SHB-RAUM-ZEIT-ALT-BEB-SHA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/SHB-RAUM-ZEIT-ALT-BEB-SHA> ;
        ?property ?value.
