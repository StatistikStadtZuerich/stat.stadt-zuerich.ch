...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/EHS-RAUM-ZEIT-SEX-WSE/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/EHS-RAUM-ZEIT-SEX-WSE> ;
        ?property ?value.
