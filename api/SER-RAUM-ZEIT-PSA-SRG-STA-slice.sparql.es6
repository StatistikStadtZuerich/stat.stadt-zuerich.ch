...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/SER-RAUM-ZEIT-PSA-SRG-STA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/SER-RAUM-ZEIT-PSA-SRG-STA> ;
        ?property ?value.
