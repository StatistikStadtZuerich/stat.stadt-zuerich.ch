...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/BRW-RAUM-ZEIT-ALT-HEA-HEL-SEX/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/BRW-RAUM-ZEIT-ALT-HEA-HEL-SEX> ;
        ?property ?value.

      # dimensions
      ?observation
        <https://ld.stadt-zuerich.ch/statistics/property/ALT> ?alt;
        <https://ld.stadt-zuerich.ch/statistics/property/HEA> ?hea;
        <https://ld.stadt-zuerich.ch/statistics/property/HEL> <https://ld.stadt-zuerich.ch/statistics/code/HEL1000>;
