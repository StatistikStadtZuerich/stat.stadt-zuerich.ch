...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/AST-RAUM-ZEIT-BTA> a qb:DataSet ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    ...
    OPTIONAL { <https://ld.stadt-zuerich.ch/statistics/dataset/AST-RAUM-ZEIT-BTA> <http://purl.org/dc/terms/license> ?license }
