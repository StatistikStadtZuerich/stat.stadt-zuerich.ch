...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/SJE-RAUM-ZEIT-KKL-PSA> a qb:DataSet ;
  ...
  GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
    <https://ld.stadt-zuerich.ch/statistics/dataset/SJE-RAUM-ZEIT-KKL-PSA> a qb:DataSet ;
      qb:slice ?defaultSlice ;
      qb:slice ?slice ;
      sdmx-attribute:unitMeasure ?unit ;
      rdfs:label ?datasetLabel .

    OPTIONAL { <https://ld.stadt-zuerich.ch/statistics/dataset/SJE-RAUM-ZEIT-KKL-PSA> <http://purl.org/dc/terms/license> ?license }
