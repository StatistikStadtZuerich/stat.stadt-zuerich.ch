...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/GBU-RAUM-ZEIT-ADV-ELK> a qb:DataSet ;
...
#  ?sliceApi rdfs:label ?sliceLabel .
  ...
  <http://stat.stadt-zuerich.ch/api/dataset/GBU-RAUM-ZEIT-ADV-ELK/shape> a sh:NodeShape ;
