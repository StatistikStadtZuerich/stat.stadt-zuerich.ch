...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/SJE-RAUM-ZEIT-PSA-SRG/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/SJE-RAUM-ZEIT-PSA-SRG> ;
        ?property ?value.
