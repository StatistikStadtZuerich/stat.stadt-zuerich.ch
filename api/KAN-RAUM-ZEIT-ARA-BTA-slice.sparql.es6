...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/KAN-RAUM-ZEIT-ARA-BTA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/KAN-RAUM-ZEIT-ARA-BTA> ;
        ?property ?value.
