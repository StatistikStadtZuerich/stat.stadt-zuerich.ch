...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/GES-RAUM-ZEIT-ALT-TOU/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/GES-RAUM-ZEIT-ALT-TOU> ;
        ?property ?value.
