...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/EIS-RAUM-ZEIT-BTA-ESA/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/EIS-RAUM-ZEIT-BTA-ESA> ;
        ?property ?value.
