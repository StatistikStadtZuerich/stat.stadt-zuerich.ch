...
CONSTRUCT {
  <http://stat.stadt-zuerich.ch/api/dataset/DOK-RAUM-ZEIT-BTA-SEX/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <http://ld.stadt-zuerich.ch/statistics/dataset/DOK-RAUM-ZEIT-BTA-SEX> ;
        ?property ?value.
