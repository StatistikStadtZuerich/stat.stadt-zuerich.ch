...
CONSTRUCT {
  <https://stat.stadt-zuerich.ch/dataset/STB-RAUM-ZEIT-ALT-SEX-WAH/slice> a qb:Slice ;
...
} WHERE {
  {
    GRAPH <https://linked.opendata.swiss/graph/zh/statistics> {
      # observations
      ?observation a qb:Observation ;
        qb:dataSet <https://ld.stadt-zuerich.ch/statistics/dataset/STB-RAUM-ZEIT-ALT-SEX-WAH> ;
        ?property ?value.
      ...
      ?observation
        ...
        <https://ld.stadt-zuerich.ch/statistics/property/WAH> <https://ld.stadt-zuerich.ch/statistics/code/WAH1100>;
